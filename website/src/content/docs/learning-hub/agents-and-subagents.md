...
> *(v1.0.72+)* **Multi-turn subagents are always enabled.** You can send follow-up messages to a running subagent at any time — this behavior no longer needs to be opted into separately.
